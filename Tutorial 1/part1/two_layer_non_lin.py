...
class MLP:
    ...
    def train(self, val_data=None, val_targets=None, verbose=False):
        ...
        for iteration in range(self.epochs):
            ...
            val_out = self.forward_pass(val_data)
    ...
    def test(self, test_data, test_targets):
        ...
        mse_error, miss_error = self.compute_error(targets_pred, test_targets)

        print('Test Error: ', miss_error)
        return miss_error
